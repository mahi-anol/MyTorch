...
@pytest.mark.task0_1
def test_operators():
    from minitorch_module0.minitorch.operators import (
        add,mul,neg,id
    )
...
def test_activation_fn():
    ...
    from minitorch_module0.minitorch.testing import assert_close
...
def test_sigmoid(a):
    ...
    from minitorch_module0.minitorch.operators import sigmoid, is_close
...
def test_transitive(a,b,c):
    ...
    from minitorch_module0.minitorch.operators import lt
...
def test_symmetric(x,y):
    ...
    from minitorch_module0.minitorch.operators import mul
    from minitorch_module0.minitorch.testing import assert_close
...
def test_distributive(x,y,z):
    ...
    from minitorch_module0.minitorch.operators import mul,add
    from minitorch_module0.minitorch.testing import assert_close
...
def test_other(a):
    ...
    from minitorch_module0.minitorch.operators import add,neg
    from minitorch_module0.minitorch.testing import assert_close
